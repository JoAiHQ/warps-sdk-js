...
- bccbc10: Extract NFT identifier from ESDTNFTCreate built-in function output
...
- ffd6b4c: Improve contract output parsing for bare `out` mappings in the MultiversX adapter.
